...
const ProgrammiPage: React.FC<ProgrammiPageProps> = ({ onCandidatiClick, currentPath, onNavigate }) => {
  return (
    <div className="animate-in fade-in duration-700 overflow-visible">
      ...
      <section className="py-24 bg-brand-black overflow-visible">
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="text-center max-w-3xl mx-auto mb-20 overflow-visible">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none text-white overflow-visible">Per chi vuole <br /><span className="gold-gradient pr-10">muoversi da solo</span></h2>
              ...
              <div className="relative p-10 border border-white/5 bg-brand-black/50 backdrop-blur-sm h-full flex flex-col justify-between overflow-visible">
                <div className="overflow-visible">
                  <div className="flex justify-between items-start mb-8 overflow-visible">
                    <span className="gold-gradient font-black text-xs uppercase tracking-[0.4em] block">PRODOTTO DIGITALE</span>
      ...
      <section className="py-24 bg-brand-gray overflow-visible">
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="bg-brand-black p-12 md:p-20 border border-brand-gold/20 relative overflow-visible">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center overflow-visible">
              <div className="overflow-visible">
                <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic text-white mb-6 overflow-visible">Vuoi il massimo <br /><span className="gold-gradient">da te stesso?</span></h3>
              ...
              <div className="lg:text-right">
                <button 
                  ...
                  className="bg-brand-gold text-brand-black px-12 py-6 font-black uppercase tracking-widest text-base hover:scale-105 transition-all shadow-xl"
                >
                  Inizia il Coaching
                </button>
              </div>
