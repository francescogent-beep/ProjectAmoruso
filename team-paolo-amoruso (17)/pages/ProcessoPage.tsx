    ...
    <div className="animate-in fade-in duration-700 overflow-visible">
        ...
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="grid lg:grid-cols-2 gap-20 items-center overflow-visible">
            <div className="relative overflow-visible">
              ...
              <h2 className="font-display text-5xl md:text-7xl font-black uppercase italic mb-8 leading-tight relative z-10 text-white overflow-visible pr-12">
                Basta <br />
                <span className="gold-gradient">allenarsi a caso</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-8 overflow-visible">
                <div className="p-6 bg-brand-gray border border-white/5 overflow-visible">
                  <h4 className="gold-gradient font-black text-xs uppercase tracking-widest mb-3 pr-6 block">Controllo Totale</h4>
                ...
                <div className="p-6 bg-brand-gray border border-white/5 overflow-visible">
                  <h4 className="gold-gradient font-black text-xs uppercase tracking-widest mb-3 pr-6 block">Piani su di te</h4>
      ...
      <section className="py-24 bg-brand-gray overflow-visible">
        <div className="max-w-4xl mx-auto px-6 text-center overflow-visible">
          <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic mb-8 text-white overflow-visible">Il Check-in: Dove succede la magia</h3>
