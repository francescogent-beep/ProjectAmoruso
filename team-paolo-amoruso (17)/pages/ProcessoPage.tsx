            ...
            <div className="relative">
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="p-6 bg-brand-gray border border-white/5">
                  <h4 className="gold-gradient font-black text-xs uppercase tracking-widest mb-3">Controllo Totale</h4>
                ...
                <div className="p-6 bg-brand-gray border border-white/5">
                  <h4 className="gold-gradient font-black text-xs uppercase tracking-widest mb-3">Piani su di te</h4>
