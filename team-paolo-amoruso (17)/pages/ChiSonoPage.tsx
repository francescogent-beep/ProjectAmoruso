        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1">
              <h2 className="font-display text-5xl md:text-8xl font-black uppercase italic mb-10 leading-none text-white">
                Perché <br />
                <span className="text-brand-gold">lo faccio.</span>
              </h2>
              ...
              <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
                ...
                <div>
                  <span className="block text-brand-gold font-display text-3xl font-black mb-1">ITA</span>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Campione 2024</span>
                </div>
                <div>
                  <span className="block text-brand-gold font-display text-3xl font-black mb-1">TOP</span>
            ...
            <div className="order-1 lg:order-2">
              <div className="relative group">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-48 h-48 border border-white/10 flex items-center justify-center backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                  <span className="text-brand-gold font-display text-xl font-bold uppercase italic">Zero Scuse</span>
                </div>
              </div>
            </div>
          </div>
