    ...
    <section id="chi-sono" className="py-24 bg-brand-gray overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="md:w-1/2">
            <span className="text-brand-gold text-xs font-black uppercase tracking-[0.4em] mb-4 block">{about.badge}</span>
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-8 text-white">{about.title}</h2>
