      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full py-24">
        <div className="max-w-4xl">
          ...
          <h1 className="font-display text-5xl md:text-8xl font-black uppercase leading-[1.05] mb-8 tracking-tight text-white">
            {words[0]} <br />
            {words[1]} {words[2]} <br />
            <span className="text-brand-gold italic pr-6 inline-block">{words[3]} {words[4]}</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button 
              ...
              className="bg-brand-gold px-10 py-5 text-brand-black font-black uppercase tracking-widest text-sm hover:scale-105 transition-transform"
            >
