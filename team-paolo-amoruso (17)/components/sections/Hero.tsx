    ...
    <section className="relative min-h-[85vh] lg:min-h-[calc(100vh-80px)] flex items-center overflow-hidden bg-brand-black" aria-labelledby="hero-title">
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-8 xl:px-12 w-full py-24">
        <div className="max-w-4xl">
          ...
          <h1 id="hero-title" className="font-display text-5xl md:text-7xl xl:text-8xl 2xl:text-9xl font-black uppercase leading-[1.05] mb-8 tracking-tight text-white">
            {words[0]} <br />
            {words[1]} {words[2]} <br />
            <span className="gold-gradient italic pr-6 drop-shadow-lg">
              {words[3]} {words[4]}
            </span>
          </h1>
