          ...
          <div className="md:w-2/3">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8">
              <a 
                ...
                className="w-full sm:w-auto bg-white text-brand-black px-12 py-5 font-black uppercase tracking-widest text-sm hover:bg-brand-gold transition-colors text-center inline-block shadow-xl"
              >
                {entryProgram.cta}
              </a>
