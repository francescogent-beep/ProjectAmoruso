  ...
  return (
    <section className="py-32 bg-brand-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <h2 className="font-display text-5xl md:text-8xl font-black uppercase italic leading-none mb-10 tracking-tighter text-white">
        ...
        <button 
          ...
          className="bg-brand-gold px-16 py-6 text-brand-black font-black uppercase tracking-[0.2em] text-lg hover:scale-105 transition-all shadow-2xl shadow-brand-gold/20"
        >
          {finalCta.cta}
        </button>
      </div>
