  ...
  return (
    <section className="py-32 bg-brand-black relative overflow-hidden border-t border-white/5" aria-labelledby="final-cta-title">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        <h2 id="final-cta-title" className="font-display text-5xl md:text-8xl font-black uppercase italic leading-none mb-10 tracking-tighter text-white">
          {finalCta.title.split(finalCta.accent)[0]} <br />
          <span className="gold-gradient italic">{finalCta.accent}</span> <br />
