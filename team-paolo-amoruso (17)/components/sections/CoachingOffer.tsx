      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2 order-2 lg:order-1">
            <h2 id="coaching-title" className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-tight text-white">
              {coaching.title} <br />
              <span className="gold-gradient italic">{coaching.accent}</span>
            </h2>
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <div className="relative aspect-[4/5] w-full max-w-[500px] mx-auto lg:max-w-none shadow-2xl">
              ...
              <div className="absolute bottom-6 right-6 bg-brand-black/90 p-4 border border-brand-gold/30">
                <p className="gold-gradient font-display font-bold italic text-lg uppercase tracking-tight">{coaching.slotsBadge}</p>
              </div>
            </div>
          </div>
        </div>
