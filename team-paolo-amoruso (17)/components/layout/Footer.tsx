        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="col-span-2">
            <a 
              ...
              aria-label="Home"
            >
              <div className="w-8 h-8 gold-metallic-bg rounded-sm flex items-center justify-center font-display font-bold text-brand-black text-xl transition-transform group-hover:scale-110">
                {SITE_CONTENT.brand.initials}
              </div>
              <span className="font-display font-bold tracking-tighter text-2xl uppercase italic text-white">
                TEAM <span className="gold-gradient">PAOLO AMORUSO</span>
              </span>
            </a>
