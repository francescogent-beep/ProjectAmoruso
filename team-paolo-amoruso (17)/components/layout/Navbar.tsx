      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-10 xl:px-12 w-full flex items-center justify-between gap-6 overflow-visible">
        ...
        >
          ...
          <div className="flex flex-col justify-center overflow-visible">
            <span className="font-display font-bold tracking-tight text-xl md:text-2xl xl:text-3xl uppercase italic text-white whitespace-nowrap leading-none pr-10 drop-shadow-md flex items-center overflow-visible">
              TEAM&nbsp;
