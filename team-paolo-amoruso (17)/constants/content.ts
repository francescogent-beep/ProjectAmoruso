export const SITE_CONTENT = {
  ...
  hero: {
    ...
    description: "Se stai leggendo, è perché una parte di te è pronta. Pronta a smettere di improvvisare. Il cambiamento parte nel momento in cui smetti di rimandare. Questo è il punto di svolta. Sta a te usarlo.",
    cta: "Candidati Ora",
  ...
  coaching: {
    ...
    accent: "METAMORFOSI",
    description: "Lavoriamo insieme sul tuo fisico, con una struttura su misura e l’esperienza accumulata arrivando tra i Pro messa al tuo servizio, giorno dopo giorno. Qui non si prova. Si costruisce..",
    features: [
  ...
  entryProgram: {
    badge: "Per iniziare",
    title: "Programma 5 Settimane",
    accent: "STRONG BASE",
    description: "Ti do una base solida, semplice da seguire, che rimette ordine e ti fa vedere i primi cambiamenti prima ancora di rendertene conto. Il resto lo fa la costanza.",
    features: [
      "Guida macronutrienti",
  ...
  socialProof: {
    ...
    items: [
      { url: "https://i.imgur.com/PDXn5DF.png", label: "Trasformazione 01" },
      { url: "https://i.imgur.com/84ZIvCE.png", label: "Trasformazione 02" },
      { url: "https://i.imgur.com/kyS2aR5.png", label: "Trasformazione 03" },
      { url: "https://i.imgur.com/RRyQ4Wb.png", label: "Trasformazione 04" }
    ]
  },
  about: {
    badge: "La mia idea",
  ...
  blogPosts: [
    ...
    },
    {
      ...
      content: `
        ...
        <h2>Como mangiano i ragazzi del mio team</h2>
