    ...
    <div className="animate-in fade-in duration-700">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative">
              ...
              <h2 className="font-display text-5xl md:text-7xl font-black uppercase italic mb-8 leading-tight relative z-10">
                Oltre il <br />
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="p-6 bg-brand-gray border border-white/5">
                  ...
                  <p className="text-zinc-500 text-xs leading-relaxed">Valutiamo non solo il peso, ma la qualità del riposo, la gestione dello stress e la capacità di recupero neurale.</p>
                </div>
                <div className="p-6 bg-brand-gray border border-white/5">
                  <h4 className="text-brand-gold font-black text-xs uppercase tracking-widest mb-3">Protocolli su Misura</h4>
                  <p className="text-zinc-500 text-xs leading-relaxed">Ogni variabile è calcolata per la tua biologia specifica. Non esistono piani "copia-incolla", solo soluzioni uniche.</p>
                </div>
              </div>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <img src="https://i.imgur.com/i5OPvRV.jpeg" alt="Metodo Pro 1" className="w-full aspect-[3/4] object-cover grayscale opacity-60 border border-white/5" />
              <img src="https://i.imgur.com/IoHpM0K.jpeg" alt="Metodo Pro 2" className="w-full aspect-[3/4] object-cover grayscale opacity-90 border border-brand-gold/20 translate-y-8" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-brand-gray">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic mb-8">Il Cuore del Successo: Il Check-in</h3>
