          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              ...
              <div className="space-y-8">
                <div className="border-l-2 border-brand-gold pl-6">
                  ...
                  <p className="text-zinc-500 text-sm">Eliminiamo ogni inefficienza. Analizziamo la tua struttura per selezionare gli esercizi che generano il massimo stimolo ipertrofico con il minimo rischio articolare.</p>
                </div>
                <div className="border-l-2 border-brand-gold pl-6">
                  <h4 className="text-white font-bold uppercase tracking-widest mb-2">02. Nutrizione Evolutiva</h4>
                  <p className="text-zinc-500 text-sm">Un piano alimentare che si adatta ai tuoi biomarkers e alla tua routine reale. Sostenibilità totale per risultati che durano nel tempo, senza inutili privazioni.</p>
                </div>
                <div className="border-l-2 border-brand-gold pl-6">
                  <h4 className="text-white font-bold uppercase tracking-widest mb-2">03. Monitoraggio Totale</h4>
                  <p className="text-zinc-500 text-sm">Non sei un numero. Check-in settimanali approfonditi e supporto diretto per calibrare ogni variabile: sonno, stress, performance e recupero.</p>
                </div>
              </div>
            </div>
            <div className="relative group">
              ...
              <div className="absolute bottom-10 left-10 right-10 p-6 bg-brand-black/90 backdrop-blur-md border border-white/5">
                <p className="text-brand-gold font-display text-2xl font-bold uppercase italic">"L'estetica è la logica conseguenza di un lavoro eseguito con precisione chirurgica."</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-brand-gray border-y border-white/5">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic mb-4">L'Ecosistema del Coaching</h3>
            <p className="text-zinc-500 uppercase tracking-[0.3em] text-xs font-bold">Tutto ciò di cui hai bisogno per dominare il tuo percorso</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 bg-brand-black border border-white/5 hover:border-brand-gold/20 transition-all">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">Allenamento, integrazione e nutrizione. Nulla è statico: ogni protocollo evolve settimanalmente in base alla tua risposta fisiologica.</p>
            </div>
            <div className="p-8 bg-brand-black border border-white/5 hover:border-brand-gold/20 transition-all">
              <div className="w-12 h-12 bg-brand-gold/10 flex items-center justify-center mb-6">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">Mandami i video dei tuoi lift. Analizzo la tua tecnica per assicurarti che ogni ripetizione sia ottimizzata per la crescita muscolare.</p>
            </div>
            <div className="p-8 bg-brand-black border border-white/5 hover:border-brand-gold/20 transition-all">
              <div className="w-12 h-12 bg-brand-gold/10 flex items-center justify-center mb-6">
              ...
              <p className="text-zinc-500 text-sm leading-relaxed">Un filo diretto per risolvere dubbi istantaneamente. Dalla scelta di un pasto fuori alla gestione di un imprevisto in palestra.</p>
            </div>
          </div>
        </div>
      </section>
