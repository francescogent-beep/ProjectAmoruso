        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20">
            ...
            <p className="text-zinc-500 text-lg max-w-2xl">
              Approfondimenti professionali su biomeccanica, nutrizione e mindset. Non semplici articoli, ma strumenti per elevare il tuo standard di conoscenza atletica.
            </p>
          </div>
