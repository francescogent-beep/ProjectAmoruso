        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col lg:flex-row justify-between items-start mb-24 gap-16">
            <div className="lg:w-2/3">
              <h2 className="font-display text-5xl md:text-8xl font-black uppercase italic mb-8 leading-none">
                La Realtà. <br />
            ...
            <div className="lg:w-1/3 w-full bg-brand-gray p-10 border border-white/5">
              <div className="space-y-8">
                <div>
                  ...
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Client Satisfaction</span>
                </div>
                <div>
                  <span className="block text-brand-gold font-display text-4xl font-black mb-1">∞</span>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Ore di Studio Biomeccanico</span>
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="p-10 border border-brand-gold/30 bg-brand-black/50 backdrop-blur-md relative">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <span className="text-zinc-600 text-[10px] uppercase font-bold">Cliente Coaching - Trasformazione 12 Mesi</span>
                  </div>
                </div>
              </div>
            </div>
