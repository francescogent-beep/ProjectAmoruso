      ...
      <div className="bg-brand-black border-b border-white/5 pt-32 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl">
            <nav className="flex items-center space-x-3 text-[10px] font-black uppercase tracking-[0.3em] mb-6">
              <a href="/" onClick={(e) => { e.preventDefault(); onNavigate('/'); }} className="text-zinc-500 hover:text-white transition-colors">Home</a>
              <span className="text-zinc-800">/</span>
              <a href="/blog" onClick={(e) => { e.preventDefault(); onNavigate('/blog'); }} className="text-zinc-500 hover:text-white transition-colors">Blog</a>
              <span className="text-zinc-800">/</span>
              <span className="text-brand-gold italic">Articolo</span>
            </nav>
            
            <div className="flex items-center space-x-4 mb-4">
              <span className="text-brand-gold text-[10px] font-black uppercase tracking-[0.4em] bg-brand-gold/10 px-3 py-1">
                {post.category}
              </span>
            ...
            <h1 className="font-display text-4xl md:text-7xl font-black uppercase italic tracking-tighter text-white leading-none mb-8">
              {post.title}
            </h1>
          </div>
        </div>
          ...
          <article className="lg:w-2/3">
            ...
            <div 
              className="prose prose-invert prose-brand max-w-2xl 
                         ...
                         prose-p:text-zinc-400 prose-p:text-lg prose-p:leading-[1.8] prose-p:mb-10 prose-p:tracking-wide
                         prose-strong:text-white prose-strong:font-bold
                         prose-blockquote:border-l-brand-gold prose-blockquote:bg-white/5 prose-blockquote:p-8 prose-blockquote:italic prose-blockquote:text-zinc-300 prose-blockquote:my-12 prose-blockquote:text-xl
                         prose-hr:border-white/10 prose-hr:my-16
                         prose-li:text-zinc-400 prose-li:mb-4 prose-li:text-lg
            ...
            <div className="mt-32 p-10 bg-brand-gray border border-white/5 flex flex-col md:flex-row items-center gap-10 max-w-2xl">
              ...
              <div>
                ...
                <p className="text-zinc-500 text-sm italic mb-4">IFBB Pro Athlete & Founder of Team PA. Specializzato in biomeccanica applicata all'ipertrofia e nutrizione per la ricomposizione corporea d'élite.</p>
            ...
            <div className="sticky top-32">
                ...
                <div className="space-y-6">
                  {SITE_CONTENT.blogPosts
                    ...
                    .map(rel => (
                      ...
                      >
                        <span className="block text-[9px] text-zinc-600 font-bold uppercase tracking-widest mb-1">{rel.category}</span>
              ...
              <div className="p-8 bg-brand-gold text-brand-black">
                ...
                <button 
                  ...
                  className="w-full bg-brand-black text-white py-4 font-black uppercase tracking-widest text-xs hover:scale-105 transition-all"
                >
