    ...
    <section id="risultati" className="py-24 bg-brand-black">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-end mb-16">
          <div>
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic">{socialProof.title}</h2>
            <p className="text-zinc-500 uppercase tracking-widest text-xs font-bold mt-2">{socialProof.subtitle}</p>
          </div>
