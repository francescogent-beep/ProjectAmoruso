    ...
    <div className="animate-in fade-in duration-700">
      ...
      <section className="py-24 bg-brand-black">
        <div className="max-w-5xl mx-auto px-6">
          ...
          {/* Header Intro */}
          <div className="mb-16">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none">
              ...
              <button
                ...
                className={`px-6 py-2 text-[10px] font-bold uppercase tracking-[0.2em] border transition-all ${
                  activeCategory === cat 
                    ...
                    : 'bg-transparent border-white/10 text-zinc-500 hover:border-brand-gold/50'
                }`}
              >
                {cat}
              </button>
                ...
                >
                  ...
                  >
                    <div className="flex items-start space-x-6">
                      <span className={`font-display text-xl font-black transition-colors ${isOpen ? 'text-brand-gold' : 'text-zinc-800'}`}>
                        {(globalIndex + 1).toString().padStart(2, '0')}
                      </span>
                      <span className={`font-display text-lg md:text-xl font-bold uppercase italic tracking-tight transition-colors ${isOpen ? 'text-white' : 'text-zinc-400 group-hover:text-zinc-200'}`}>
                        {item.q}
                      </span>
                    </div>
          ...
          <div className="mt-20 p-12 bg-brand-gray border border-white/5 text-center">
            <h4 className="font-display text-2xl font-bold uppercase italic mb-4">Hai altre domande?</h4>
