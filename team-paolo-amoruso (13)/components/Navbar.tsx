...
const Navbar: React.FC<NavbarProps> = ({ onCandidatiClick, onNavigate, currentPath }) => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 h-20 flex items-center border-b border-white/5 transition-colors duration-300 ${isMobileMenuOpen ? 'bg-black' : 'bg-brand-black/80 backdrop-blur-md'}`}>
