    ...
    <div className="animate-in fade-in duration-700">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">
                <div>
                  ...
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">IFBB League</span>
                </div>
                <div>
                  <span className="block text-brand-gold font-display text-3xl font-black mb-1">10Y+</span>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Experience</span>
                </div>
                <div>
                  <span className="block text-brand-gold font-display text-3xl font-black mb-1">ABS</span>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Champion 2024</span>
                </div>
                <div>
                  <span className="block text-brand-gold font-display text-3xl font-black mb-1">ELITE</span>
                  <span className="text-zinc-500 text-[10px] uppercase font-bold tracking-widest">Coach Status</span>
                </div>
              </div>
            </div>
      ...
      <section className="py-24 bg-brand-gray border-t border-white/5">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic mb-8 text-white">Pochi, Ma Eccellenti</h3>
