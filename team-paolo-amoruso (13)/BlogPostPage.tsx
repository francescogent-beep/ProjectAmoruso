        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl">
            <nav className="flex items-center space-x-3 text-[10px] font-black uppercase tracking-[0.3em] mb-6">
              <a href="/" onClick={(e) => { e.preventDefault(); onNavigate('/'); }} className="text-zinc-400 hover:text-white transition-colors">Home</a>
              <span className="text-zinc-700">/</span>
              <a href="/blog" onClick={(e) => { e.preventDefault(); onNavigate('/blog'); }} className="text-zinc-400 hover:text-white transition-colors">Blog</a>
              <span className="text-zinc-700">/</span>
