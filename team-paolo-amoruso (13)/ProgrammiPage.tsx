      ...
      <section className="py-24 bg-brand-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none text-white">Strumenti per <br /><span className="text-brand-gold">Autonomi Ambiziosi</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-12 mb-24">
            ...
            <div className="p-10 border border-white/5 bg-zinc-900/10 flex flex-col justify-center items-center text-center">
              ...
              <h3 className="font-display text-2xl font-bold uppercase italic text-zinc-400 mb-4">In Sviluppo</h3>
