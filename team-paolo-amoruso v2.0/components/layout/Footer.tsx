    ...
    <footer className="bg-brand-black border-t border-white/5 py-20" aria-label="Piè di pagina">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="col-span-2">
            ...
            >
              ...
              <div className="flex flex-col justify-center overflow-visible">
                <span className="font-display font-bold tracking-tight text-xl md:text-2xl uppercase italic text-white whitespace-nowrap leading-none pr-2 drop-shadow-md flex items-center overflow-visible">
                  TEAM&nbsp;
                  <span className="gold-gradient pr-4">
                    AMORUSO
                  </span>
                </span>
                <span className="text-[7px] md:text-[8px] text-zinc-400 font-black uppercase tracking-[0.4em] mt-1 ml-0.5 opacity-80">
        ...
        <div className="mt-20 pt-8 border-t border-white/5 flex flex-col lg:flex-row justify-between items-center gap-6 text-center lg:text-left">
          ...
          <p className="text-zinc-400 text-[10px] uppercase font-bold tracking-widest order-3 lg:order-2">
          ...
          <p className="text-zinc-400 text-[10px] uppercase font-bold tracking-widest lg:order-3">
