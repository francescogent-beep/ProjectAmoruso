...
const CoachingOffer: React.FC<CoachingOfferProps> = ({ onCandidatiClick }) => {
  ...
  // Imgur Optimization: Use high-quality (h) or large (l) thumbnails for mobile efficiency
  const baseImg = coaching.image.replace(/\.(jpe?g|png)$/i, '');
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center overflow-visible">
          <div className="lg:w-1/2 order-2 lg:order-1 overflow-visible">
            ...
            <button 
              ...
              className="w-full sm:w-auto gold-solid-bg font-display font-black uppercase px-12 py-5 text-lg tracking-widest shadow-lg"
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <div className="relative aspect-[4/5] w-full max-w-[500px] mx-auto lg:max-w-none shadow-2xl">
              ...
              <img 
                src={`${baseImg}h.webp`} 
                srcSet={`${baseImg}l.webp 640w, ${baseImg}h.webp 1024w`}
