...
const Qualification: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-brand-black perf-section-defer">
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 xl:px-12">
        <div className="text-center mb-16 overflow-visible">
          <h2 className="font-display text-4xl md:text-5xl xl:text-6xl font-black uppercase italic mb-4 overflow-visible">
            {qualification.title}
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
          <div className="p-8 md:p-12 xl:p-16 bg-brand-gray border border-white/5 group hover:border-brand-gold/30 transition-colors overflow-visible">
            <h3 className="font-display text-2xl xl:text-3xl font-bold uppercase gold-gradient mb-8 italic pr-8">
          ...
          <div className="p-8 md:p-12 xl:p-16 bg-zinc-900/30 border border-white/5 opacity-80 overflow-visible">
