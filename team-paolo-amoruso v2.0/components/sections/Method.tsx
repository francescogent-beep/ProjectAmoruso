...
const Method: React.FC = () => {
  ...
  return (
    <section id="processo" className="py-24 bg-brand-black perf-section-defer">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {method.steps.map((step, idx) => (
            <div key={idx} className="relative group">
              <span 
                aria-hidden="true"
                className="font-display text-7xl font-black text-white/[0.4] absolute -top-10 -left-4 -z-0 group-hover:text-white/[0.55] transition-colors"
              >
                {step.num}
              </span>
