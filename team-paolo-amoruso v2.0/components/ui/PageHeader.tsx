...
const PageHeader: React.FC<PageHeaderProps> = ({ title, subtitle, category, date }) => {
  return (
    <section className="relative w-full bg-brand-black pt-8 md:pt-12 pb-16 md:pb-24 border-b border-white/5 overflow-visible">
      <div className="max-w-7xl mx-auto px-6 overflow-visible">
        <div className="max-w-4xl overflow-visible">
          ...
          <h1 className="font-display text-4xl md:text-7xl lg:text-8xl font-black uppercase italic tracking-tighter text-white leading-[0.95] pr-12 animate-in fade-in slide-in-from-left-8 duration-1000 overflow-visible">
            {title}
          </h1>
        </div>
      </div>
