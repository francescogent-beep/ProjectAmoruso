          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center overflow-visible">
            <div className="relative overflow-visible">
              ...
              <h2 className="font-display text-5xl md:text-7xl font-black uppercase italic mb-8 leading-tight relative z-10 text-white overflow-visible pr-12">
                Basta <br />
                <span className="text-brand-gold">allenarsi a caso</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-2 gap-8 overflow-visible">
                <div className="p-6 bg-brand-gray border border-white/5 overflow-visible">
                  <h4 className="text-brand-gold font-black text-xs uppercase tracking-widest mb-3 block">Controllo Totale</h4>
                ...
                <div className="p-6 bg-brand-gray border border-white/5 overflow-visible">
                  <h4 className="text-brand-gold font-black text-xs uppercase tracking-widest mb-3 block">Piani su di te</h4>
