...
const BlogPage: React.FC<BlogPageProps> = ({ currentPath, onNavigate, onCandidatiClick }) => {
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <PageHeader 
        title="Il Mio Blog" 
        subtitle="Consigli, Metodo & Verità" 
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none text-white">
              Le Mie <br /><span className="text-brand-gold">Guide</span>
            </h2>
            <p className="text-zinc-400 text-lg max-w-2xl">
              Qui trovi articoli semplici e chiari su come allenarti meglio, cosa mangiare e come restare motivato. Niente paroloni tecnici, solo quello che ti serve per migliorare.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-8 flex flex-col flex-1">
                  ...
                  <div className="mt-auto">
                    ...
                    >
                      <span className="text-white text-xs font-black uppercase tracking-[0.2em] border-b border-brand-gold/40 pb-1 group-hover/link:border-brand-gold transition-all">Leggi l'articolo</span>
