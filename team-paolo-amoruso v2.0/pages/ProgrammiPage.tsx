...
const ProgrammiPage: React.FC<ProgrammiPageProps> = ({ onCandidatiClick, currentPath, onNavigate }) => {
  return (
    <div className="animate-in fade-in duration-700 overflow-visible">
      ...
      {/* Intro Header */}
      <section className="pt-24 pb-12 bg-brand-black overflow-visible">
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="text-center max-w-3xl mx-auto overflow-visible">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase italic mb-6 leading-none text-white overflow-visible">
              Per chi vuole <br /><span className="text-brand-gold pr-10">muoversi da solo</span>
            </h2>
      ...
      {/* Main detailed program block */}
      <EntryProgram />

      {/* Program Summary Cards Grid */}
      <section className="py-24 bg-brand-black overflow-visible border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="grid md:grid-cols-2 gap-12 mb-24 overflow-visible">
            <div className="relative group overflow-visible">
              <div className="absolute inset-0 bg-brand-gold/5 group-hover:bg-brand-gold/10 transition-colors duration-500"></div>
              <div className="relative p-10 border border-white/5 bg-brand-black/50 backdrop-blur-sm h-full flex flex-col justify-between overflow-visible">
                <div className="overflow-visible">
                  <div className="flex justify-between items-start mb-8 overflow-visible">
                    <span className="text-brand-gold font-black text-xs uppercase tracking-[0.4em] block">PRODOTTO DIGITALE</span>
                    <span className="text-white/20 font-display text-4xl font-black">01</span>
                  </div>
                  <h3 className="font-display text-3xl font-bold uppercase italic text-white mb-6 overflow-visible">Strong Base 5.0</h3>
            ...
            <div className="p-10 border border-white/5 bg-zinc-900/10 flex flex-col justify-center items-center text-center">
              ...
              <h3 className="font-display text-2xl font-bold uppercase italic text-zinc-400 mb-4 overflow-visible">In Arrivo</h3>
      ...
      {/* Coaching invitation block */}
      <section className="py-24 bg-brand-gray overflow-visible border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 overflow-visible">
          <div className="bg-brand-black p-12 md:p-20 border border-brand-gold/20 relative overflow-visible">
             <div className="absolute top-0 right-0 p-12 overflow-hidden opacity-5 pointer-events-none">
              <span className="font-display text-[200px] font-black italic text-brand-gold">PRO</span>
            </div>
            <div className="relative z-10 grid lg:grid-cols-2 gap-12 items-center overflow-visible">
              <div className="overflow-visible">
                <h3 className="font-display text-3xl md:text-5xl font-black uppercase italic text-white mb-6 overflow-visible">
                  Vuoi il massimo <br /><span className="text-brand-gold">da te stesso?</span>
                </h3>
              ...
              <div className="lg:text-right">
                <button 
                  ...
                  className="gold-solid-bg font-display font-black uppercase px-12 py-6 tracking-widest text-lg hover:scale-105 transition-all shadow-xl"
                >
                  Inizia il Coaching
                </button>
              </div>
